...
class CoherenceParameters(Parameters):
    ...
    def load_params(self, master, attrbs) -> List[
        ...
        atribs = [self._signals, self._check_all_signals, self._taper1, self._taper2, self._sample_frequency, self._frequencies, self._freq_pass1, self._freq_pass2, self._time1, self._time2, self._trialave, self._err]
